                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle active-nav" href="#" id="navbarDropdown"
                                                role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                Services
                                            </a>
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <li><a class="dropdown-item" href="credit-repair.php">Credit Repair</a>
                                                </li>
                                                <li><a class="dropdown-item" href="credit-approval.php">Credit
                                                        Approvals</a></li>
                                                <li><a class="dropdown-item" href="credit-limit.php">Increase Credit
                                                        Limit</a></li>
                                                <li><a class="dropdown-item" href="negative-item.php">Remove Negative
                                                        Items</a></li>
                                                <li><a class="dropdown-item active-nav"
                                                        href="tradelines.php">Tradelines</a></li>
                                            </ul>
